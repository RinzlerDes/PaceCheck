...
int main(void)
{
    ...
    printf("LOOPBACK running: 1000 us square on PD12 (Arduino D2) -- "
           "jumper D2 to D5 for the capture-path self-test.\n");
    printf("Type a line (e.g. 'e 1500') and press Enter; "
    ...
    static const uint8_t colors[][3] = {
        {32u, 0u, 0u}, {0u, 32u, 0u}, {0u, 0u, 32u}, {32u, 32u, 32u},
    };
    ...
    for (;;) {
        ...
        rgb_set(colors[color_idx][0], colors[color_idx][1],
                colors[color_idx][2]);
